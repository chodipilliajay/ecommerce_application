...
import {deleteUser, getSingleUser, getUserDetails, getUsersList, googleAuth, loginUser, logout, registerUser, requestPasswordReset, resetPassword, updatePassword, updateProfile, updateUserRole} from '../controller/userController.js';
