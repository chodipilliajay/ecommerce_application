...
import { createProducts, createReviewForProduct, deleteProduct, deleteReview, getAdminProducts, getAllProducts, getDealProducts, getNewArrivals, getProductReviews, getSingleProduct, updateProduct } from '../controller/productController.js';
...
router.route("/products/deals").get(getDealProducts);
